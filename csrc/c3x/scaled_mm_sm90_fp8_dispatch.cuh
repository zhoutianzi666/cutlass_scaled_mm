...
void cutlass_gemm_caller_sm90_fp8(paddle::Tensor& out, paddle::Tensor const& a,
...
inline void cutlass_gemm_sm90_fp8_dispatch(paddle::Tensor& out,
  ...
  uint32_t const m = a.shape()[0];
  uint32_t const n = b.shape()[0];
  uint32_t const k = a.shape()[1];
